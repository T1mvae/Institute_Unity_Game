...
namespace Institute.World
{
    ...
    public class RegionTypeDefinition
    {
        ...
        // Base stats (0..20) before variance, terrain composition and difficulty.
        public int influenceBase = 9;
        public int stabilityBase = 10;
        public int developmentBase = 9;
        public int statVariance = 2;
    ...
    public class RegionTypeDefinitionCollection
    {
        ...
        public static RegionTypeDefinitionCollection CreateDefault()
        {
            ...
            Add("KingdomHeartland",     "Kingdom Heartland",     13, 14, 12, 2, 1.6f, new[] {"Plains", "Hills"},      new[] {"core"});
            Add("FeudalProvince",       "Feudal Province",       10, 11, 10, 2, 1.0f, new[] {"Plains", "Forest"},     new[] {"feudal"});
            Add("FrontierMarch",        "Frontier March",         8, 10,  6, 3, 1.1f, new[] {"Hills", "Forest"},      new[] {"frontier"});
            Add("TradeBasin",           "Trade Basin",           11, 10, 14, 2, 0.9f, new[] {"Coast", "Plains"},      new[] {"trade"});
            Add("TempleDomain",         "Temple Domain",         12, 14,  8, 2, 0.8f, new[] {"SacredLand", "Hills"},  new[] {"religious"});
            Add("TribalConfederation",  "Tribal Confederation",   7,  9,  6, 3, 1.2f, new[] {"Forest", "Hills"},      new[] {"tribal"});
            Add("RuinedZone",           "Ruined Zone",            5,  6,  5, 4, 0.7f, new[] {"Ruins", "Wasteland"},   new[] {"ruined", "artifacts"});
            Add("CoastalLeague",        "Coastal League",        10, 11, 12, 2, 1.0f, new[] {"Coast"},                new[] {"coastal", "trade"});
            Add("MountainClans",        "Mountain Clans",         9, 12,  7, 2, 0.8f, new[] {"Hills"},                new[] {"highland"});
            Add("NeutralSettlement",    "Neutral Settlement",     8, 11,  9, 2, 0.6f, new[] {"Plains"},               new[] {"neutral"});
            return c;
        }
    }
}
